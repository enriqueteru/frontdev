    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        <a
          ...
          className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm ring-1 ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus:outline-none focus-visible:outline-blue-600 focus-visible:ring-slate-300"
        >
          <svg
            aria-hidden="true"
